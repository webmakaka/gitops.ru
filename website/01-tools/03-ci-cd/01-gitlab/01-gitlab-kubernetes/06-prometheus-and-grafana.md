...
permalink: /tools/ci-cd/gitlab/kubernetes/prometheus-and-grafana/
---
...
![GitOps](/img/tools/ci-cd/gitlab/kubernetes/pic-lecture04-pic01.png?raw=true)

<br/>

И в Targets

![GitOps](/img/tools/ci-cd/gitlab/kubernetes/pic-lecture04-pic02.png?raw=true)
